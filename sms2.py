...
print "======================================="
print " Author  : Fahmi"
print " FaceBok : Fahmi 2121"
print " GitHub  : https://github.com/zfahmi2121"
print "======================================="
print
time.sleep(2)
...
if pilih == "1":
      ...
      print "[+]Selanjutnya ketik $python2 darkpremium.py"
        ...
        os.system('git clone https://github.com/zfahmi2121/bonto')
        time.sleep(4)
        print "[+]Selanjutnya ketik $cd bonto"
        time.sleep(3)
        print "[+]Selanjutnya ketik $python2 sms1"
elif pilih == "4": 
