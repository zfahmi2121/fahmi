	...
	def Spam():
		...
		if PilihTools == '1':
			...
			try:
				...
				print
				Phd(Phone, 3) # CHANGE / JANGAN DI UBAH
			...
			os.system('xdg-open http://wa.me/085299187816?text=Hallo')
...
if __name__ == '__main__':
	print(C+'Subscribe YT'+W+' Gua Dlu Ya Su Tea Syappu Madodo dodo !'+C+' :V')
	sleep(2)
	os.system('clear')
	os.system('xdg-open https://www.youtube.com/channel/UCE__ySaMqV-VZOA0zsLPVPg')
	sleep(7)
	Spam()
